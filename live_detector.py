...
#
cfg_path = "./yolov3.cfg"
weight_path= "./yolov3_custom_object_last.weights"
...
def main():
    ...
    ap.add_argument('-c', '--confidence', required=False, help = 'confidence threshold')
    ap.add_argument('-m', '--nms', required=False, help = 'NMS threshold', type=float)
    ap.add_argument('-w', '--weights', required=False, help='spec weights', type=float)
    ap.add_argument('-l', '--labels', required=False, help='spec labels')
    ap.add_argument('-b', '--isCam', required=True, help='isCam', type=bool, choices=[True, False])
    ap.add_argument('-p', '--preview', required=True, help='onOff preview', type=bool)
